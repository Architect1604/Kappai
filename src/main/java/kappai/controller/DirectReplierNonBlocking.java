...
public class DirectReplierNonBlocking {
    ...
    private static final String TOPIC_PREFIX = "gf/";  // used as the topic "root"
    ...
    public static void main(String... args) throws IOException {
        ...
        RequestReplyMessageReceiver requestReplyMessageReceiver = messagingService.requestReply().createRequestReplyMessageReceiverBuilder().build(TopicSubscription.of(TOPIC_PREFIX + "login/req"));
