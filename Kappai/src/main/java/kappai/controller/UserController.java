...
public class UserController {
    ...
    private static final String SAMPLE_NAME = UserController.class.getSimpleName();
    private static final String TOPIC = "gf/user/req/>";  // used as the topic "root"
...
//          System.out.println("The inbound message is : " + inboundMessage.dump()); // Enable this for learning purposes as it logs a String representation of the whole Message
    ...
    private static String callDAO(String requestTopic, String jsonInput) {
        ...
        case "gf/user/req/login/user" :
        	jsonResponse = callLoginDAO(jsonInput);
        	break;
        	
        case "gf/user/req/create/user" :
        	jsonResponse = callSignUpDAO(jsonInput);
        	break;	
...
private static String callSignUpDAO(String jsonInput) {
    	...
    	try {
			...
			System.out.println("username="+jsonObject.getString("username"));
			System.out.println("password="+jsonObject.getString("password"));
			System.out.println("confirmPassword="+jsonObject.getString("confirmPassword"));
			System.out.println("emailID="+jsonObject.getString("emailID"));
			System.out.println("phoneNumber="+jsonObject.getString("phoneNumber"));
	        ...
	        userVOInput.setFirstName(jsonObject.getString("firstName"));
	        userVOInput.setLastName(jsonObject.getString("lastName"));
	        userVOInput.setUsername(jsonObject.getString("username"));
	        userVOInput.setPassword(jsonObject.getString("password"));
	        userVOInput.setConfirmPassword(jsonObject.getString("confirmPassword"));
	        userVOInput.setEmailId(jsonObject.getString("emailID"));
	        userVOInput.setPhoneNumber(jsonObject.getString("phoneNumber"));
	        userVOInput.setAddress(jsonObject.getString("address"));
	        
	        userVOOutput = userDAO.createUser(userVOInput);
	        //System.out.println("userVOInput="+userVOInput);
	        //System.out.println("userVOOutput="+userVOOutput);
